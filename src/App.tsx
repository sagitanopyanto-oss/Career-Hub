...
export default function App() {
  ...
  // Core Database States (falling back to initial mock lists if local storage is empty)
      ...
      <div className="flex-1 flex flex-col overflow-hidden min-w-0">
        ...
        <header className="h-16 bg-white border-b border-slate-200 shrink-0 flex items-center justify-between px-3 sm:px-4 md:px-6 z-10 gap-2">
          <div className="flex items-center gap-2 sm:gap-3 min-w-0">
            ...
            {/* Desktop Expand Button removed from header, now handled in Sidebar component */}
          ...
          <div className="flex items-center gap-2 sm:gap-3 md:gap-4 shrink-0">
            {/* Quick Notify - popup appears below button on left side */}
